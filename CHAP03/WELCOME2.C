...
MRESULT EXPENTRY Client1WndProc (HWND, ULONG, MPARAM, MPARAM) ;
MRESULT EXPENTRY Client2WndProc (HWND, ULONG, MPARAM, MPARAM) ;
...
MRESULT EXPENTRY Client1WndProc (HWND hwnd, ULONG msg, MPARAM mp1, MPARAM mp2)
     {
...
MRESULT EXPENTRY Client2WndProc (HWND hwnd, ULONG msg, MPARAM mp1, MPARAM mp2)
     {
